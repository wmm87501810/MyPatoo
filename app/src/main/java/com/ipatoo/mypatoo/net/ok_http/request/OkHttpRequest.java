...
public abstract class OkHttpRequest {
    ...
    public static class Builder {
        ...
        public Builder files(List<Pair<String, File>> fileList) {
        ...
        public OkHttpRequest uploadList(ResultCallback callback) {
            OkHttpRequest request = new OkHttpUploadRequest(url, tag, params, headers, fileList);
            request.invokeAsyn(callback);
            return request;
        }
        ...
        public OkHttpRequest patch(ResultCallback callback) {
            OkHttpRequest request = new OkHttpPatchRequest(url, tag, params, headers, content);
            request.invokeAsyn(callback);
            return request;
        }

        public OkHttpRequest delete(ResultCallback callback) {
            OkHttpRequest request = new OkHttpDeleteRequest(url, tag, params, headers, content, json);
            request.invokeAsyn(callback);
            return request;
        }

        public OkHttpRequest put(ResultCallback callback) {
            OkHttpRequest request = new OkHttpPutRequest(url, tag, params, headers, json);
            request.invokeAsyn(callback);
            return request;
        }
